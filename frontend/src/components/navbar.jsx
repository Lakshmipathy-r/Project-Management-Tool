      ...
      <div className="flex items-center justify-between px-4 py-3 md:px-6 max-w-7xl mx-auto">
        ...
        >
          ...
          <div className="relative w-10 h-10 flex items-center justify-center rounded-xl bg-gradient-to-br from-fuchsia-500 via-purple-500 to-indigo-500 shadow-lg group-hover:shadow-purple-300/50 group-hover:scale-105 transition-all duration-300">
            ...
            <div className="absolute -bottom-1 -middle-1 w-3 h-3 bg-white rounded-full shadow-md animage-ping"></div>
          </div>
          {/* Brand name */}
        ...
        <div ref={menuref} className="relative">
          <button
            ...
            className="flex items-center gap-2 px-3 py-2 rounded-full cousor-pointer hover:bg-purple-50 transition-colors duration-300 border border-transparent hover:border-purple-200"
          >
            <div className="relative">
              {user.avatar ? (
                ...
                <div className="w-8 h-8 flex items-center justify-center rounded-full bg-gradient-to-br from-fuchia-500 to-purple-600 text-white font-semibold shadow-md">
                  {user.name ? user.name.charAt(0).toUpperCase() : "U"}
                </div>
              )}

              <div className=' absolute -bottom-0.5 -right-0.5 w-3 h-3 bg-green-400 roundedd-full border-2 border-white animate-pulse' />
            </div>
